...
if "IS_SHARED_UI" in os.environ:
    ...
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/resolve/main/sd/stable-diffusion-webui/models/Stable-diffusion/Aethergenshinmid.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/Aethergenshinmid")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/resolve/main/sd/stable-diffusion-webui/models/Stable-diffusion/Genshin_diffusion_test.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/Genshin_diffusion_test.ckpt")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/resolve/main/sd/stable-diffusion-webui/models/Lora/genshinImpactModel_v10.safetensors -O /home/user/app/stable-diffusion-webui/models/Lora/genshinImpactModel_v10.safetensors")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/resolve/main/sd/stable-diffusion-webui/models/Lora/gachaimpact_.safetensors -O /home/user/app/stable-diffusion-webui/models/Lora/gachaimpact_.safetensors")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/resolve/main/sd/stable-diffusion-webui/models/Lora/sxz-raiden-mgr.safetensors -O /home/user/app/stable-diffusion-webui/models/Lora/sxz-raiden-mgr.safetensors")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/resolve/main/sd/stable-diffusion-webui/models/Lora/raidenFromMGS_10.safetensors -O /home/user/app/stable-diffusion-webui/models/Lora/raidenFromMGS_10.safetensors")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/resolve/main/sd/stable-diffusion-webui/models/Lora/rfktrsTechnotrexV10_rfktrsTechnotrexV10.safetensors -O /home/user/app/stable-diffusion-webui/models/Lora/rfktrsTechnotrexV10_rfktrsTechnotrexV10.safetensors")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/resolve/main/sd/stable-diffusion-webui/models/Lora/jackOneillSTARGATE_v10.safetensors -O /home/user/app/stable-diffusion-webui/models/Lora/jackOneillSTARGATE_v10.safetensors")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/resolve/main/sd/stable-diffusion-webui/models/lora/danielJackson_v10.safetensors -O /home/user/app/stable-diffusion-webui/models/Lora/danielJackson_v10.safetensors")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/resolve/main/sd/stable-diffusion-webui/models/Lora/johnBarrowman_v1.safetensors -O /home/user/app/stable-diffusion-webui/models/Lora/johnBarrowman_v1.safetensors")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/resolve/main/sd/stable-diffusion-webui/models/Lora/davidTennant_v1.safetensors -O /home/user/app/stable-diffusion-webui/models/Lora/davidTennant_v1.safetensors")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/resolve/main/sd/stable-diffusion-webui/models/Lora/doomSlayer_doomSlayer20.safetensors -O /home/user/app/stable-diffusion-webui/models/Lora/doomSlayer_doomSlayer20.safetensors")
    #os.system(f"wget -q https://huggingface.co/runwayml/stable-diffusion-v1-5/resolve/main/v1-5-pruned-emaonly.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/v1-5-pruned-emaonly.ckpt")
    #os.system(f"wget -q https://huggingface.co/runwayml/stable-diffusion-inpainting/resolve/main/sd-v1-5-inpainting.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/sd-v1-5-inpainting.ckpt")
