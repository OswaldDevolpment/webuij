...
if "IS_SHARED_UI" in os.environ:
    ...
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/blob/main/sd/stable-diffusion-webui/models/Stable-diffusion/Aethergenshinmid.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/Aethergenshinmid")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/blob/main/sd/stable-diffusion-webui/models/Stable-diffusion/Genshin_diffusion_test.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/Genshin_diffusion_test.ckpt")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/blob/main/sd/stable-diffusion-webui/models/Stable-diffusion/genshinImpactModel_v10.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/genshinImpactModel_v10.ckpt")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/blob/main/sd/stable-diffusion-webui/models/Stable-diffusion/gachaimpact_.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/gachaimpact_.ckpt")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/blob/main/sd/stable-diffusion-webui/models/Stable-diffusion/sxz-raiden-mgr.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/sxz-raiden-mgr.ckpt")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/blob/main/sd/stable-diffusion-webui/models/Stable-diffusion/raidenFromMGS_10.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/raidenFromMGS_10.ckpt")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/blob/main/sd/stable-diffusion-webui/models/Stable-diffusion/rfktrsTechnotrexV10_rfktrsTechnotrexV10.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/rfktrsTechnotrexV10_rfktrsTechnotrexV10.ckpt")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/blob/main/sd/stable-diffusion-webui/models/Stable-diffusion/jackOneillSTARGATE_v10.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/jackOneillSTARGATE_v10.ckpt")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/blob/main/sd/stable-diffusion-webui/models/Stable-diffusion/danielJackson_v10.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/danielJackson_v10.ckpt")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/blob/main/sd/stable-diffusion-webui/models/Stable-diffusion/johnBarrowman_v1.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/johnBarrowman_v1.ckpt")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/blob/main/sd/stable-diffusion-webui/models/Stable-diffusion/davidTennant_v1.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/davidTennant_v1.ckpt")
    os.system(f"wget -q https://huggingface.co/AdamOswald1/test/blob/main/sd/stable-diffusion-webui/models/Stable-diffusion/doomSlayer_doomSlayer20.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/doomSlayer_doomSlayer20.ckpt")
    #os.system(f"wget -q https://huggingface.co/runwayml/stable-diffusion-v1-5/resolve/main/v1-5-pruned-emaonly.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/v1-5-pruned-emaonly.ckpt")
    #os.system(f"wget -q https://huggingface.co/runwayml/stable-diffusion-inpainting/resolve/main/sd-v1-5-inpainting.ckpt -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/sd-v1-5-inpainting.ckpt")
